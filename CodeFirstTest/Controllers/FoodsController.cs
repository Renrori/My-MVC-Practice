    ...
    public class FoodsController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Foods != null ? 
                          ...
                          Problem("Entity set 'FoodStoreContext.Foods'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("FoodId,Title,ISBN")] Food food)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("FoodId,Title,ISBN")] Food food)
        {
            if (id != food.FoodId)
            {
                return NotFound();
